 ...
 */
package com.yixin.garage.core.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import com.yixin.garage.core.common.constant.dictmap.base.AbstractDictMap;
import com.yixin.garage.core.common.constant.dictmap.factory.DictFieldWrapperFactory;
            ...
            for (Field field : fields) {
                ...
                if (!o1.toString().equals(o2.toString())) {
                    ...
                    if (fieldWarpperMethodName != null) {
                        Object o1Warpper = DictFieldWrapperFactory.createFieldWrapper(o1, fieldWarpperMethodName);
                        Object o2Warpper = DictFieldWrapperFactory.createFieldWrapper(o2, fieldWarpperMethodName);
    ...
    public static String parseMutiKey(AbstractDictMap dictMap, String key, Map<String, String> requests) {
        ...
        if (key.contains(",")) {
            ...
            for (String item : keys) {
                ...
                if (fieldWarpperMethodName != null) {
                    Object valueWarpper = DictFieldWrapperFactory.createFieldWrapper(value, fieldWarpperMethodName);
