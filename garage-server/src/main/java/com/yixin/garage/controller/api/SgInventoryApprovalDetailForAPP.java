 ...
 */
@RestController
@RequestMapping("/api/sgInventoryDetail")
public class SgInventoryApprovalDetailForAPP {

    private final static Logger logger=LoggerFactory.getLogger(SgInventoryApprovalDetailForAPP.class);
