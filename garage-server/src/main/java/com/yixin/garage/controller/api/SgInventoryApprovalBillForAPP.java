 ...
 */
@RestController
@RequestMapping("/api/sgInventoryBill")
public class SgInventoryApprovalBillForAPP {

    private final static Logger logger=LoggerFactory.getLogger(SgInventoryApprovalBillForAPP.class);
