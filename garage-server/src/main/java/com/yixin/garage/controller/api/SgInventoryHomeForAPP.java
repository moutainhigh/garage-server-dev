...
import com.yixin.garage.service.inventory.impl.SgInventoryHomeServiceImpl;
 ...
 */
@RestController
@RequestMapping("/api/sgInventoryHome")
public class SgInventoryHomeForAPP {

    private final static Logger logger=LoggerFactory.getLogger(SgInventoryHomeForAPP.class);
    ...
    */
    ...
    public InvokeResult<List<SgInventoryGrageIdsDTO>> getGarageInfoListForApp(@RequestBody SgInventoryHomeDTO dto) {
        ...
        try {
            ...
            logger.error("getGarageInfoListForApp() failed：", e);
            result.failure("error");
        }
        return result;
    }
